...
# PK 컬럼 3개 값이 모두 일치하는 중복 데이터 삽입 시도
INSERT INTO order_composite_pk
(SELECT *
 FROM order_composite_pk WHERE user_id = 3);
# Duplicate entry '3-100-2026-06-12 11:31:54' for key 'order_composite_pk.PRIMARY'

### FOREIGN KEY(외래키)
# - 참조(REFERENCE)된 다른 테이블에서 제공 하는 값만 사용 가능
